...
// --- NUEVOS EVENTOS PARA EL MODO ONLINE Y ESTADO DEL SERVIDOR ---
...
if (window.location.hostname !== 'localhost' && window.location.hostname !== '127.0.0.1') {
    ...
    // PING PARA DESPERTAR/VERIFICAR SERVIDOR DE RENDER
    if (statusBadge) {
    ...
    if (statusBadge) statusBadge.style.display = 'none'; // No mostrar en local
}
